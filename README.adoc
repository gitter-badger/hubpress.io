...
image:https://badges.gitter.im/shurikan117-blog/Lobby.svg[link="https://gitter.im/shurikan117-blog/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
:toc: macro
:toclevels: 4
:sectnums:
